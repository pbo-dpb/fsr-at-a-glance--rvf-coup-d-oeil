<template>
    <li class="cursor-pointer leading-tight">
        <a @click="selectRegion"
            class="rounded border-blue-800 border p-4 w-fit lg:w-full lg:border-0 lg:px-4 lg:py-2 block  text-blue-800 dark:text-blue-200 underline hover:text-blue-900 dark:hover:text-blue-100 select-none"
            ...
            <span class="hidden lg:block">{{
                ...
                strings.infographic_type }}</span><span class="lg:hidden font-semibold">{{ region ? region.id.toUpperCase()
        :
